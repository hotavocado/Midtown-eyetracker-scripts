...
par.CD_START  = 80+block_perm(2);
par.CD_END = 100+block_perm(2);
% par.CD_SECONDS = 44;
%tt = 0;
...
sca
movie_presentation_order{end+1,1} = moviename_select(block_perm(2));
...
% [success, ivx]=iViewX('datafile', ivx, ['C:\PsychToolbox_Experiments\Simon\HBN\AA_eyetracker_data\' subj_ID{1,1} '_Video2'  '.idf']);
% 
...
save([par.runID , '_Video2'],'block_perm','exclude','movie_presentation_order','par') 
close all
