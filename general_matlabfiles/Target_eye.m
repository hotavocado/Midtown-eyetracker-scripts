...
if par.useEL, [success, ivx]=iViewX('message', ivx, [ num2str(num2str(par.CD_Dot_ON(pos_num)))]); end
...
if par.useEL, [success, ivx]=iViewX('message', ivx, [ num2str(num2str(par.CD_Dot_OFF(pos_num)))]); end
